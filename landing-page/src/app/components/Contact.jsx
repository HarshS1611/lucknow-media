                ...
                <div className="flex items-center mt-10">
                    <div className="flex justify-center items-center gap-4">
                                ...
                                >
                                    ...
                                    >
                                        <path
                                            ...
                                            className="group-hover:fill-[#ecebed] fill-white duration-300"
                                        ></path>
                                        <path
                        ...
                        <div className="social-button">
                            <button className="relative w-12 h-12 rounded-full group">
                                <div
                                    className="floater w-full h-full absolute top-0 left-0 bg-black border-white border-2 rounded-full duration-300 group-hover:-top-8 group-hover:shadow-2xl"
                                ></div>
                                <div
